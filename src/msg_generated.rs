...
const ENUM_MAX_EVENT_TYPE: i8 = 2;
...
#[allow(non_camel_case_types)]
const ENUM_VALUES_EVENT_TYPE:[EventType; 3] = [
  EventType::Fetch,
  EventType::Resolv,
  EventType::Serve
];
...
#[allow(non_camel_case_types)]
const ENUM_NAMES_EVENT_TYPE:[&'static str; 3] = [
    "Fetch",
    "Resolv",
    "Serve"
];
...
impl<'a> Base<'a> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn msg_as_service_request(&'a self) -> Option<ServiceRequest> {
    if self.msg_type() == Any::ServiceRequest {
      self.msg().map(|u| ServiceRequest::init_from_table(u))
    } else {
      None
    }
  }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn msg_as_service_response(&'a self) -> Option<ServiceResponse> {
    if self.msg_type() == Any::ServiceResponse {
      self.msg().map(|u| ServiceResponse::init_from_table(u))
    } else {
      None
    }
  }
...
impl<'a> flatbuffers::Follow<'a> for ServiceRequest<'a> {
    type Inner = ServiceRequest<'a>;
    #[inline]
    fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
        Self {
            _tab: flatbuffers::Table { buf: buf, loc: loc },
...
impl<'a> ServiceRequest<'a> {
  ...
  pub fn data(&self) -> Option<&'a str> {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ServiceRequest::VT_DATA, None)
  }
}
...
pub struct ServiceRequestBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> ServiceRequestBuilder<'a, 'b> {
  #[inline]
  pub fn add_id(&mut self, id: u32) {
  ...
  pub fn add_data(&mut self, data: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ServiceRequest::VT_DATA, data);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> ServiceRequestBuilder<'a, 'b> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<ServiceRequest<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

pub enum ServiceResponseOffset {}
#[derive(Copy, Clone, Debug, PartialEq)]
...
impl<'a> flatbuffers::Follow<'a> for ServiceResponse<'a> {
    type Inner = ServiceResponse<'a>;
    #[inline]
    fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
        Self {
            _tab: flatbuffers::Table { buf: buf, loc: loc },
...
impl<'a> ServiceResponse<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args ServiceResponseArgs<'args>) -> flatbuffers::WIPOffset<ServiceResponse<'bldr>> {
      let mut builder = ServiceResponseBuilder::new(_fbb);
      if let Some(x) = args.data { builder.add_data(x); }
      builder.add_id(args.id);
  ...
  #[inline]
  pub fn id(&self) -> u32 {
    self._tab.get::<u32>(ServiceResponse::VT_ID, Some(0)).unwrap()
  }
  #[inline]
  pub fn success(&self) -> bool {
    self._tab.get::<bool>(ServiceResponse::VT_SUCCESS, Some(false)).unwrap()
  }
  #[inline]
  pub fn data(&self) -> Option<&'a str> {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ServiceResponse::VT_DATA, None)
  }
}

pub struct ServiceResponseArgs<'a> {
    pub id: u32,
    pub success: bool,
    pub data: Option<flatbuffers::WIPOffset<&'a  str>>,
}
impl<'a> Default for ServiceResponseArgs<'a> {
    #[inline]
    fn default() -> Self {
        ServiceResponseArgs {
            id: 0,
...
pub struct ServiceResponseBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> ServiceResponseBuilder<'a, 'b> {
  #[inline]
  pub fn add_id(&mut self, id: u32) {
    self.fbb_.push_slot::<u32>(ServiceResponse::VT_ID, id, 0);
  }
  #[inline]
  pub fn add_success(&mut self, success: bool) {
    self.fbb_.push_slot::<bool>(ServiceResponse::VT_SUCCESS, success, false);
  }
  #[inline]
  pub fn add_data(&mut self, data: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ServiceResponse::VT_DATA, data);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> ServiceResponseBuilder<'a, 'b> {
    let start = _fbb.start_table();
